...
from utils.commands import getColmap, getRCprocess
...
def main():
    ...
    with open(fname) as qualityParamsFile:
    ...
    with open(fname) as processStepsFile:
    ...
    if( from_step != "default" or to_step != "default" or exclude_steps != []):
        ...
        # select steps
        newsteps = []
        adding_steps = from_step == "default"
