    ...
    def runProcessSteps(self):
        for step in self.steps:
            ...
            if "app" in step:
                ...
                if self.args["dry_run"]:
                    print("function : {}({})".format(step["function"], ", ".join([ "{}={}".format(key, ([updateStringFromDict(item, self.args) for item in val]
                    ...
                    if ret is not None:
                        ...
                        print ("After step {}: Setting args[{}]={}".format( step["function"], ret[0] , ret[1] ))
